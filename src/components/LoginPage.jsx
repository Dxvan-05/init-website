...
function LoginPage({ loginToggle } ) {
    ...
    return (
        <div className="flex w-screen h-svh justify-center items-center" id='login'>
            <section className="rounded-md bg-black/70 p-2 inline-block2 min-w-[450px]">
                <div className="flex items-center justify-center bg-white px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
                    <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
                        <div className="mb-2">
                            <Link to='/' ><img src={initStar} className='h-[56px] w-[56px]' /></Link>
                        </div>
